...
inline void PrintJson(const Json::Value& val)
{
...
inline void FormatWindowsHuman(const std::vector<PROTOCOL_WINDOW_INFO>& windows)
{
    if (windows.empty())
    {
...
inline void FormatTabsHuman(const std::vector<PROTOCOL_TAB_INFO>& tabs)
{
    if (tabs.empty())
    {
...
inline void FormatPanesHuman(const std::vector<PROTOCOL_PANE_INFO>& panes)
{
    if (panes.empty())
    {
...
inline void FormatActivePaneHuman(const PROTOCOL_PANE_INFO& info)
{
...
inline void FormatPaneStatusHuman(const PROTOCOL_PROCESS_STATUS& status)
{
...
inline void FormatCreatedTabHuman(const PROTOCOL_TAB_CREATION_RESULT& result)
{
...
inline void FormatCreatedPaneHuman(const PROTOCOL_TAB_CREATION_RESULT& result)
{
    auto paneId = WideToUtf8(BstrToWstring(result.PaneId));
...
inline Json::Value WindowInfoToJson(const PROTOCOL_WINDOW_INFO& w)
{
    Json::Value v;
...
inline Json::Value TabInfoToJson(const PROTOCOL_TAB_INFO& t)
{
    Json::Value v;
...
inline Json::Value PaneInfoToJson(const PROTOCOL_PANE_INFO& p)
{
    Json::Value v;
...
inline Json::Value PaneOutputToJson(const PROTOCOL_PANE_OUTPUT& o)
{
    Json::Value v;
...
inline Json::Value CreationResultToJson(const PROTOCOL_TAB_CREATION_RESULT& r)
{
    Json::Value v;
